...
class Book {
  constructor() {
    ...
    this.date = faker.date.past(30).toLocaleDateString();
    ...
    this.state = {
      columnDefs: [
        ...
        },
        {
          ...
          field: "bookname",
          width: 250,
          cellStyle: { fontFamily: "Tangerine", fontSize: "30px" }
        },
        {
          headerName: "Author",
          field: "author",
      ...
      rowClassRules: {
        ...
        financeLastFriday: function(params) {
          ...
          let last_friday = lastFridayOfMonth(
            date.getFullYear(),
            date.getMonth()
          ).toLocaleDateString();

          return (
            date_localised === last_friday && params.data.genre === "finance"
          );
        },
...
const TableInfo = () => (
  <div className={"info"}>
    ...
    <p className={"fridayHalloween"}>
      This Is 'Halloween' Last Friday Of Month
    </p>
...
const BigListAgGrid = () => {
  let [books] = useState(createBooks(NUMBER_OF_RECORDS));
